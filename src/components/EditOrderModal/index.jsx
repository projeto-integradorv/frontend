              ...
              <ListItemText
                ...
                secondary={
                  <>
                    ...
                    <Typography variant="body2">Adicionais:</Typography>
                    {item.additionals && item.additionals.length > 0 ? (
                      <List dense>
                        {item.additionals.map((additional) => (
                          <ListItem key={additional.id} disableGutters>
                            <ListItemText
                              primary={
                                <Typography variant="body2">
    ...
    if (selectedOrder) {
      return (
        <Box display={'flex'} flexDirection={'column'} component={'div'}>
          ...
          <Typography variant='body-1' component={'p'}>
            <strong>Pagamento:</strong> {selectedOrder.payment_type}
          </Typography>
          <Typography variant='body-1' component={'p'}>
          ...
          <Box mt={2}>
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} label="Atualizar Status" variant="outlined" />
              )}
            />
            <Button
              variant="contained"
